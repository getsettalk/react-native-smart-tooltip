...
import { View, Modal, Pressable, StyleSheet, Dimensions, Animated, Easing, Text, } from 'react-native';
const { width: SCREEN_WIDTH } = Dimensions.get('window');
const Tooltip = ({ content, children, backgroundColor = '#333333', textColor = '#FFFFFF', textAlign = 'left', containerStyle, textStyle, borderRadius = 8, maxWidth = 280, }) => {
    ...
    if (isMeasured) {
        ...
        if (pointerLeft < minPointerX)
            pointerLeft = minPointerX;
        if (pointerLeft > maxPointerX)
            pointerLeft = maxPointerX;
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Pressable, { ref: triggerRef, onPress: handlePress, collapsable: false, children: children }), _jsx(Modal, { visible: isVisible, transparent: true, animationType: "none", children: _jsx(Pressable, { style: styles.overlay, onPress: closeTooltip, children: !isMeasured ? (_jsx(View, { onLayout: (e) => {
                            setTooltipSize({
                            ...
                            containerStyle,
                        ], children: _jsx(Text, { style: [styles.tooltipText, { color: textColor, textAlign }, textStyle], children: content }) })) : (_jsxs(Animated.View, { style: [
                            styles.tooltipContainer,
                            {
                                backgroundColor,
                                borderRadius,
                            ...
                            containerStyle,
                        ], children: [_jsx(Text, { style: [styles.tooltipText, { color: textColor, textAlign }, textStyle], children: content }), _jsx(View, { style: [
                                    styles.triangle,
